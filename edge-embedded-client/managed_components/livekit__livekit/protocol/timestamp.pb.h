...
typedef struct google_protobuf_timestamp {
...
extern const pb_msgdesc_t google_protobuf_timestamp_t_msg;

/* Defines for backwards compatibility with code written before nanopb-0.4.0 */
#define GOOGLE_PROTOBUF_TIMESTAMP_FIELDS &google_protobuf_timestamp_t_msg
